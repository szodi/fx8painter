...
public class CurveDrawer
{
	...
	{
		double x = (1 - t) * (1 - t) * (1 - t) * point1.getX() + 3 * t * (1 - t) * (1 - t) * point2.getX() + 3 * t * t * (1 - t) * point3.getX() + t * t * t * point4.getX();
		double y = (1 - t) * (1 - t) * (1 - t) * point1.getY() + 3 * t * (1 - t) * (1 - t) * point2.getY() + 3 * t * t * (1 - t) * point3.getY() + t * t * t * point4.getY();
		double z = (1 - t) * (1 - t) * (1 - t) * point1.getZ() + 3 * t * (1 - t) * (1 - t) * point2.getZ() + 3 * t * t * (1 - t) * point3.getZ() + t * t * t * point4.getZ();
