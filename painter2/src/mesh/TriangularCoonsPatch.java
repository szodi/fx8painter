...
public class TriangularCoonsPatch
{
	ControlPoint p1;
	ControlPoint p2;
	ControlPoint p3;

	public TriangularCoonsPatch(ControlPoint p1, ControlPoint p2, ControlPoint p3)
	{
		this.p1 = p1;
		this.p2 = p2;
		this.p3 = p3;
	...
	{
		return Tools.getBezierPoint(p1, p1.getTangent(p2), p2.getTangent(p1), p2, s);
	}
	...
	{
		return Tools.getBezierPoint(p1, p1.getTangent(p3), p3.getTangent(p1), p3, t);
	}

	private MutablePoint3D d1(double t)
	{
		return Tools.getBezierPoint(p2, p2.getTangent(p3), p3.getTangent(p2), p3, t);
	}
